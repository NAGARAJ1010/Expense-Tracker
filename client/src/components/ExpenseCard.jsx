...
const ExpenseCard = ({ data, viewTransaction }) => {
  const isoDate = data.date;
  const formattedDate = dayjs(isoDate).format("DD-MM-YYYY");
  return (
    <div
      className="expense-card-container flex justify-between py-4 px-6 bg-white border border-gray-100 rounded-xl cursor-pointer"
